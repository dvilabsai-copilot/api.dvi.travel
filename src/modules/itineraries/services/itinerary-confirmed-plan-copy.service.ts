      ...
      for (const h of hotels) {
        const confirmedHotel = await tx.dvi_confirmed_itinerary_plan_hotel_details.create({
          data: {
            ...
            hotel_provider: h.hotel_provider,
            hotel_booking_mode: h.hotel_booking_mode,
            price_source: h.price_source,
            is_live_rate: h.is_live_rate,
            selected_rate_option_id: h.selected_rate_option_id,
            selected_price_per_night: h.selected_price_per_night,
            selected_total_price: h.selected_total_price,
            selected_currency: h.selected_currency,
            selected_price_snapshot: h.selected_price_snapshot,
            hotel_approval_status: h.hotel_approval_status,
            hotel_approval_requested_at: h.hotel_approval_requested_at,
            hotel_approval_requested_by: h.hotel_approval_requested_by,
            hotel_approved_at: h.hotel_approved_at,
            hotel_approved_by: h.hotel_approved_by,
            hotel_rejected_at: h.hotel_rejected_at,
            hotel_rejected_by: h.hotel_rejected_by,
            hotel_approval_notes: h.hotel_approval_notes,
            manual_confirmation_status: h.manual_confirmation_status,
            manual_confirmation_requested_at: h.manual_confirmation_requested_at,
            manually_confirmed_at: h.manually_confirmed_at,
            manually_confirmed_by: h.manually_confirmed_by,
            manual_confirmation_notes: h.manual_confirmation_notes,
            requires_price_reacceptance: h.requires_price_reacceptance,
          },
        });

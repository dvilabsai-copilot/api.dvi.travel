...
export class ItinerariesService {
  ...
  constructor(
    ...
    this.matrixSafeInsertionService.setCallbacks({
      ...
      buildMatrixRescheduledPreviewTimeline: (...args) => (this.buildMatrixRescheduledPreviewTimeline as any)(...args),
      ...
      resolveProgressivePriorityRemovalForManualFitInTx: (...args) => (this.resolveProgressivePriorityRemovalForManualFitInTx as any)(...args),

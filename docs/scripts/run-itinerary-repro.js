...
const createPayload = {
  // Repro itinerary aligned with current UI state:
  // Chennai Airport -> Madurai -> Rameswaram -> Rameswaram -> Munnar -> Chennai Airport
  plan: {
    agent_id: 8,
    staff_id: 0,
    location_id: 0,
    ...
    hotel_facilities: [],
    trip_start_date: '2026-05-14T08:00:00+05:30',
    trip_end_date: '2026-05-18T20:00:00+05:30',
    pick_up_date_and_time: '2026-05-14T08:00:00+05:30',
    arrival_type: 1,
    departure_type: 1,
    no_of_nights: 4,
    no_of_days: 5,
    ...
    child_count: 0,
    infant_count: 0,
    special_instructions: 'Repro of DVI20260320 route pattern - Chennai/Madurai/Rameswaram/Munnar',
  },
  routes: [
    {

...
## Iteration 136 evidence update

- The preference-filter extraction preserves category/meal predicates, unknown-category exceptions, room alignment, price selection, provider warnings and null-map handling; no SQL predicate, index, Redis cache or response shape changed.

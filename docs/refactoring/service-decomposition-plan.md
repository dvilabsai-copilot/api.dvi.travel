...
| `timeline.builder.ts` | 8,794 lines / 31 DB-call matches | route processing; hotspot selection; travel legs; operating hours/cutoffs | pure timeline policy tests -> candidate policy -> input loader -> policy services | ordering/timing parity |
